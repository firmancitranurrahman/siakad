            ...
            <div class='row'>
               <div class='col-md-6 col-lg-6'>
                   <div class="form-group shadow-textarea">
                        ...
                        <textarea class="form-control " id="judul" placeholder="Ketik Pengumuman"></textarea>
                   </div>
              </div>
            </div>
            <div class='row'>
                <div class='col-md-6 col-lg-6'>
                    <div class="form-group shadow-textarea">
                        ...
                        <textarea class="form-control z-depth-1" id="isi" rows="3" placeholder="Ketik Pengumuman"></textarea>
                    </div>
                </div>
            </div>
